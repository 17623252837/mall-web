    ...
    methods: {
      ...
      handleDelete(index, row) {
        this.$confirm('是否要删除该资源?', '提示', {
          ...
          deleteResource(row.id,this.$store.state.user.token).then(response => {
            this.$message({
              type: 'success',
              message: '删除成功!'
            });
      ...
      handleDialogConfirm() {
        this.$confirm('是否要确认?', '提示', {
          ...
          if (this.isEdit) {
            updateResource(this.resource.id,this.resource,this.$store.state.user.token).then(response => {
              this.$message({
                message: '修改成功！',
                type: 'success'
              });
            ...
            createResource(this.resource,this.$store.state.user.token).then(response => {
              this.$message({
                message: '添加成功！',
                type: 'success'
              });
      ...
      getCateList(){
        listAllCate(this.$store.state.user.token).then(response=>{
