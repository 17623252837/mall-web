    ...
    methods: {
      ...
      handleDialogConfirm() {
        this.$confirm('是否要确认?', '提示', {
          ...
          if (this.isEdit) {
            updateResourceCategory(this.resourceCategory.id,this.resourceCategory,this.$store.state.user.token).then(response => {
              this.$message({
                message: '修改成功！',
                type: 'success'
              });
            ...
            createResourceCategory(this.resourceCategory,this.$store.state.user.token).then(response => {
              this.$message({
                message: '添加成功！',
                type: 'success'
              });
